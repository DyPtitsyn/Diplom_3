...
class TestPasswordRecovery:
    ...
    @allure.description('При клике на ссылку "Восстановить пароль" на странице авторизации происходит переход на страницу восстановление пароля')
    ...
    @allure.description('После ввода email и клика на кнопку "Восстановить", происходит переход на страницу, где можно установить новый пароль ')
