...
class TestPersonalAccount:
    ...
    @allure.description('При клике на кнопку "История заказов" в личном кабинете происходит переход в раздел "История заказов"')
    ...
    @allure.description('При клике на кнопку "Выход" в личном кабинете происходит выход из аккаунта и переход на страницу авторизации')
